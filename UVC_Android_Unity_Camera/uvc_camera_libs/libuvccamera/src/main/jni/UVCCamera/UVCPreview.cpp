...
uvc_frame_t *UVCPreview::get_frame(size_t data_bytes) {
	...
	__android_log_print(ANDROID_LOG_VERBOSE, "Unity", "get_frame");
#endif
...
#ifdef CODEFLOW_DEBUG
	__android_log_print(ANDROID_LOG_VERBOSE, "Unity", "recycle_frame");
#endif
...
#ifdef CODEFLOW_DEBUG
	__android_log_print(ANDROID_LOG_VERBOSE, "Unity", "init_pool");
#endif
...
int UVCPreview::setFrameCallback(JNIEnv *env, jobject frame_callback_obj, int pixel_format) {
	...
	#ifdef CODEFLOW_DEBUG
	__android_log_print(ANDROID_LOG_VERBOSE, "Unity", "setFrameCallback pixelFormat : %i", pixel_format);
#endif
...
#ifdef CODEFLOW_DEBUG
	__android_log_print(ANDROID_LOG_VERBOSE, "Unity", "callbackPixelFormatChanged : %i ", mPixelFormat);
#endif
...
#ifdef CODEFLOW_DEBUG
	__android_log_print(ANDROID_LOG_VERBOSE, "Unity", "PIXEL_FORMAT_RAW");
#endif
...
#ifdef CODEFLOW_DEBUG
	__android_log_print(ANDROID_LOG_VERBOSE, "Unity", "PIXEL_FORMAT_YUV");
#endif
...
#ifdef CODEFLOW_DEBUG
	__android_log_print(ANDROID_LOG_VERBOSE, "Unity", "PIXEL_FORMAT_RGB565");
#endif
...
#ifdef CODEFLOW_DEBUG
	__android_log_print(ANDROID_LOG_VERBOSE, "Unity", "PIXEL_FORMAT_RGBX");
#endif
...
#ifdef CODEFLOW_DEBUG
	__android_log_print(ANDROID_LOG_VERBOSE, "Unity", "PIXEL_FORMAT_YUV20SP");
#endif
...
#ifdef CODEFLOW_DEBUG
	__android_log_print(ANDROID_LOG_VERBOSE, "Unity", "PIXEL_FORMAT_NV21");
#endif
...
#ifdef CODEFLOW_DEBUG
	__android_log_print(ANDROID_LOG_VERBOSE, "Unity", "startPreview");
#endif
...
#ifdef CODEFLOW_DEBUG
	__android_log_print(ANDROID_LOG_VERBOSE, "Unity", "stopPreview");
#endif
...
#ifdef CODEFLOW_DEBUG
	__android_log_print(ANDROID_LOG_VERBOSE, "Unity", "addPreviewFrame");
#endif
...
#ifdef CODEFLOW_DEBUG
	__android_log_print(ANDROID_LOG_VERBOSE, "Unity", "do_preview");
#endif
...
#ifdef CODEFLOW_DEBUG
	__android_log_print(ANDROID_LOG_VERBOSE, "Unity", "draw_preview_one");
#endif
...
#ifdef CODEFLOW_DEBUG
	__android_log_print(ANDROID_LOG_VERBOSE, "Unity", "do_capture_surface");
#endif
...
#ifdef CODEFLOW_DEBUG
	__android_log_print(ANDROID_LOG_VERBOSE, "Unity", "do_capture_callback");
#endif
